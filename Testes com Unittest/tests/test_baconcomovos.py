...
class TestBaconComOvos(unittest.TestCase):
    ...
    def test_baccon_com_ovos_deve_retornar_bacon_com_ovos_se_entrada_for_multiplo_de_3_e_5(self):
    ...
    def test_baccon_com_ovos_deve_retornar_passar_fome_se_entrada_nao_for_multiplo_de_3_e_5(self):
        entradas = (1, 2, 7, 11)
        saida = 'Passar fome'
    ...
    def test_baccon_com_ovos_deve_retornar_bacon_se_entrada_for_multiplo_de_3(self):
    ...
    def test_baccon_com_ovos_deve_retornar_ovos_se_entrada_for_multiplo_de_5(self):
