...
class Banco:
    def __init__(
        ...
        # Se os parâmetros forem None, criará uma lista vazia
...
if __name__ == '__main__':
    c1 = pessoas.Cliente('Rodrigo', 27)
    cc1 = contas.ContaCorrente(111, 222, 0, 0)
    c1.conta = cc1
    # print(c1)
    # print(c1.conta)

    c2 = pessoas.Cliente('Maria', 22)
    cp1 = contas.ContaPoupanca(124, 411, 3)
    c2.conta = cp1

    banco = Banco()
    banco.clientes.extend([c1, c2])
    banco.contas.extend([cc1, cp1])
    banco.agencias.extend([111, 456])
